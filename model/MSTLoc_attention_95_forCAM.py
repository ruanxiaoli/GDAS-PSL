...
#        self.frm = FRM(336, 336)
    ...
    def forward(self, x):
        ...
        x_FESM1_suppression = x_suppression
        
        # Second layer
        x_enhance = self.FESM2(x_suppression)[0]
#        Second
        x_enhance.retain_grad()
        x_FESM2_enhance = x_enhance
...
#        Second
        x_suppression.retain_grad()
        x_FESM2_suppression = x_suppression

        # Third layer
        x_enhance = self.FESM3(x_suppression)[0]
#        Third
        x_enhance.retain_grad()
        x_FESM3_enhance = x_enhance
...
#        Third
        x_suppression.retain_grad()
        x_FESM3_suppression = x_suppression
        
        # Fourth layer
        x_enhance = self.FESM4(x_suppression)[0]
#		Fourth
        x_enhance.retain_grad()
        x_FESM4_enhance = x_enhance
        
        x_enhance = self.vit4(x_enhance)
        

        x_suppression = self.FESM4(x_suppression)[1]
        #        Fourth
        x_suppression.retain_grad()
        x_FESM4_suppression = x_suppression
        ...
        return x,x_FESM4_enhance,x_FESM4_suppression
#        return x
