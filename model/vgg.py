...
class VGG16(nn.Module):
    def __init__(self):
        ...
        conv2.add_module('pool2', nn.AvgPool2d(2, stride=2))
        self.conv2 = conv2
        ...
        conv3.add_module('pool3_1', nn.AvgPool2d(2, stride=2))
        self.conv3 = conv3
        ...
        conv4_1.add_module('pool4_1', nn.AvgPool2d(2, stride=2))
        ...
        conv5_1.add_module('pool5_1', nn.AvgPool2d(2, stride=2))
        ...
        pre_train = torch.load("/home/x2000/MSTLoc/cache/vgg16-397923af.pth")
