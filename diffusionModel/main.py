...
if __name__ == '__main__':
    ...
    diffusion = Diffusion(restore_timesteps=config['diffusion']['restore_timesteps'],
                          ...
                          # cond=config['model_MSTLoc']['cond']
                          )

    # #### GET DATALOADERS #########################################################
    # train dataloader
    train_dataset = Dataset("./utils/train_pre.npy", transform=None)
    ...
    # val dataloader
    val_dataset = Dataset_test("./utils/test_pre.npy")
